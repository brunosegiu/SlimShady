...
vec4 blur13(sampler2D image, vec2 uv, vec2 resolution) {
  ...
  color += texture2D(image, uv + (off1 / resolution).x) * 0.2969069646728344;
  color += texture2D(image, uv - (off1 / resolution).x) * 0.2969069646728344;
  color += texture2D(image, uv + (off2 / resolution).x) * 0.09447039785044732;
  color += texture2D(image, uv - (off2 / resolution).x) * 0.09447039785044732;
  color += texture2D(image, uv + (off3 / resolution).x) * 0.010381362401148057;
  color += texture2D(image, uv - (off3 / resolution).x) * 0.010381362401148057;
  return color;
}
